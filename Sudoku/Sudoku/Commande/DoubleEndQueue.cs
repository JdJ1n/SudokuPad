...
{
    public class DoubleEndQueue<T> : ICollection, IEnumerable<T>
    {
        #region constants
        ...
        public DoubleEndQueue(IEnumerable<T> collection, bool isAddTail)
        {
            if (collection == null)
            {
        ...
        {
            #region fields
            private DoubleEndQueue<T> deque;
            private int index;
            private T current;
            private int version;
            #endregion
            ...
            #region constructors
            public Enumerator(DoubleEndQueue<T> deque)
            {
                this.deque = deque;
                this.index = -1;
